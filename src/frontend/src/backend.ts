...
import type { RequestStatus as _RequestStatus, Time as _Time, TransportRequest as _TransportRequest, UserProfile as _UserProfile, UserRole as _UserRole, UserRole__1 as _UserRole__1 } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllRequests(): Promise<Array<TransportRequest>> {
        if (this.processError) {
            try {
    ...
    async getTransportRequest(arg0: bigint): Promise<TransportRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.getTransportRequest(arg0);
    ...
    async registerUser(arg0: string, arg1: UserRole): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerUser(arg0, to_candid_UserRole_n16(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async switchRole(arg0: UserRole): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateRequestStatus(arg0: bigint, arg1: RequestStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRequestStatus(arg0, to_candid_RequestStatus_n20(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_TransportRequest_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TransportRequest): TransportRequest {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        driver: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.driver)),
        farmer: value.farmer,
...
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "driver" in value ? UserRole.driver : "farmer" in value ? UserRole.farmer : value;
}
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? RequestStatus.pending : "pickedUp" in value ? RequestStatus.pickedUp : "delivered" in value ? RequestStatus.delivered : "accepted" in value ? RequestStatus.accepted : value;
}
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TransportRequest>): Array<TransportRequest> {
    return value.map((x)=>from_candid_TransportRequest_n4(_uploadFile, _downloadFile, x));
}
function to_candid_RequestStatus_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: RequestStatus): _RequestStatus {
...
function to_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: RequestStatus): {
    pending: null;
} | {
    pickedUp: null;
} | {
